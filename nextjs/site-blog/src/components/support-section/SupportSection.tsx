...
export const SupportSection = () => {
  return (
    <section className="relative pb-8 md:py-10 bg-gray-700">
      ...
      md:block bg-[url('/background-features.svg')] bg-cover 
      bg-center bg-no-repeat opacity-90"
      />
    ...
    text-heading-xl text-gray-100"
        >
          Sua loja de afilados, simples, do jeito que deveria ser
        </h2>

        <div className="grid gap-6 md:grid-cols-3">
          {/* Primeiro Card*/}
          <div className="flex flex-col text-left gap-2 rouded-lg p-6  md:p-12 bg-blue-400">
            <div
         ...
         bg-blue-300 mb-5"
          ...
          {/* Segundo Card*/}
          <div className="flex flex-col text-left gap-2 rouded-lg p-6  md:p-12 bg-cyan-300">
            <div
              className="flex h-12 w-12 items-center justify-center rounded-lg
         bg-cyan-200 mb-5"
            >
